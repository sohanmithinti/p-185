...
import {View, Text, Stylesheet, SafeAreaView, TouchableOpacity, Platfrom, StatusBar, Image} from "react-native";
            ...
            <View style = {styles.container}>
                ...
                <View style = {styles.headingContainer}>
                    ...
                    <View style = {{flexDirection: "row", flexWrap: "wrap"}}>
                        ...
                        <Text style = {styles.subHeading2}> cool frame </Text>
                    </View>
                </View>
                <View style = {styles.contentContainer}>
                    <View style = {{flex: 0.5}}>
                    <Text style={styles.contentText}>
                        Experience the virtual experience of trying out different frames from our wide collection on your mobile phone before making any purchase, just how you would in an offline store!
                    </Text>
                    </View>
